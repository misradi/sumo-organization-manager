...
// APIClient manages communication with the Sumo Logic Organizations Management API API v1.0.0
...
type APIClient struct {
	...
	OrganizationsManagementAPI *OrganizationsManagementAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.OrganizationsManagementAPI = (*OrganizationsManagementAPIService)(&c.common)
